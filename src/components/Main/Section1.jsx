  ...
  return (
    <div>
      <div className="w-full px-[156px] py-[180px]">
          ...
          <div className="bg-[#F5F6F9] h-[532px] 3xl:h-[600px] w-full mt-10 rounded-4xl py-4 pr-4 pl-13 flex items-center justify-center gap-10">
            <div className="w-[47%]">
            ...
            <div className="h-[500px] w-[53%] rounded-2xl bg-[#F2F3F7] bg-[url(./Groupbg.png)] bg-cover flex justify-evenly items-center gap-1 p-1">
              <div className=" bg-white rounded-xl p-3.5 flex flex-col items-center justify-center">
